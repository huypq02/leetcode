...
| Binary Search   | 12    | Binary Search, Find Minimum in Rotated Sorted Array, Find the Distance Value Between Two Arrays, First Bad Version, Koko Eating Bananas, Median of Two Sorted Arrays, Missing Number, Search in Rotated Sorted Array, Search Insert Position, Sqrt(x), Time Based Key-Value Store, Valid Perfect Square                                                                                                                                                                                                                                                                                                                                                                                  |
