...
- **[Count the Number of Incremovable Subarrays I](Arrays/count-the-number-of-incremovable-subarrays-i/)** - Finding incremovable subarrays in arrays
...
- **[Fruits into Baskets II](Arrays/fruits-into-baskets-ii/)** - Sliding window for collecting fruits from baskets
...
- **[Array Partition](Greedy/array-partition/)** - Greedy algorithm for maximum sum of minimums
- **[Can Place Flowers](Greedy/can-place-flowers/)** - Greedy placement of flowers in a linear bed
- **[Largest Perimeter Triangle](Greedy/largest-perimeter-triangle/)** - Greedy selection of triangle sides for maximum perimeter
- **[Lemonade Change](Greedy/lemonade-change/)** - Greedy change-making for lemonade transactions

### 🔍 Binary Search

- **[Arranging Coins](Binary-Search/arranging-coins/)** - Finding staircase rows using binary search
- **[Binary Search](Binary-Search/binary-search/)** - Classic O(log n) search in sorted arrays
- **[Count Pairs Whose Sum is Less Than Target](Binary-Search/count-pairs-whose-sum-is-less-than-target/)** - Counting valid pairs using binary search on sorted array
- **[Fair Candy Swap](Binary-Search/fair-candy-swap/)** - Finding pair for equal candy distribution using binary search
...
- **[Find Smallest Letter Greater Than Target](Binary-Search/find-smallest-letter-greater-than-target/)** - Finding next greater letter using binary search
- **[Find Target Indices After Sorting Array](Binary-Search/find-target-indices-after-sorting-array/)** - Finding all target indices after sorting using binary search
...
- **[Guess Number Higher or Lower](Binary-Search/guess-number-higher-or-lower/)** - Binary search guessing game with feedback
- **[Koko Eating Bananas](Binary-Search/koko-eating-bananas/)** - Binary search for optimization problems
- **[Kth Missing Positive Number](Binary-Search/kth-missing-positive-number/)** - Finding kth missing positive number using binary search
- **[Longest Subsequence With Limited Sum](Binary-Search/longest-subsequence-with-limited-sum/)** - Finding longest subsequence within sum limit using binary search
- **[Maximum Count of Positive Integer and Negative Integer](Binary-Search/maximum-count-of-positive-integer-and-negative-integer/)** - Finding maximum count using binary search
- **[Median of Two Sorted Arrays](Binary-Search/median-of-two-sorted-arrays/)** - Binary search approach to find median efficiently
- **[Minimum Common Value](Binary-Search/minimum-common-value/)** - Finding minimum common value between two sorted arrays using binary search
...
- **[Special Array With X Elements Greater Than or Equal X](Binary-Search/special-array-with-x-elements-greater-than-or-equal-x/)** - Finding special value using binary search
...
- **[Valid Perfect Square](Binary-Search/valid-perfect-square/)** - Checking if a number is a perfect square using binary search
