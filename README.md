...
| Binary Search   | 6     | Binary Search, Find Minimum in Rotated Sorted Array, Koko Eating Bananas, Median of Two Sorted Arrays, Search in Rotated Sorted Array, Time Based Key-Value Store                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Two Pointers    | 23    | Assign Cookies, Container With Most Water, Count Binary Substrings, DI String Match, Find the Duplicate Number, Find the Index of the First Occurrence in a String, Happy Number, Intersection of Two Arrays, Intersection of Two Arrays II, Is Subsequence, Long Pressed Name, Move Zeroes, Remove Duplicates from Sorted Array, Remove Element, Reverse Only Letters, Reverse String, Reverse String II, Reverse Vowels of a String, Reverse Words in a String III, Shortest Distance to a Character, Sort Array by Parity, Sort Array by Parity II, Valid Palindrome II |
