...
| Binary Search   | 9     | Binary Search, Find Minimum in Rotated Sorted Array, Find the Distance Value Between Two Arrays, Koko Eating Bananas, Median of Two Sorted Arrays, Search in Rotated Sorted Array, Search Insert Position, Sqrt(x), Time Based Key-Value Store                                                                                                                                                                                                                                                                                                                                                                                                                                           |
